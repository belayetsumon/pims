 ...
 */
@Controller
@RequestMapping("/servicehistories")
@PreAuthorize("hasAuthority('servicehistories')")
public class ServiceHistoriesController {
    ...
    public String index(Model model, @PathVariable Long e_id, ServiceHistories serviceHistories) {
        ...
        return "pims/servicehistories/servicehistories";
    }
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid ServiceHistories serviceHistories, BindingResult bindingResult) {
        ...
        return "redirect:/servicehistories/index/{e_id}";
