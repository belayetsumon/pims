 ...
 */
@Controller
@RequestMapping("/selfservice_otherserviceinformation")
@PreAuthorize("hasAuthority('selfservice_otherserviceinformation')")
public class OtherServiceInformationSelfserviceController {
    ...
    public String index(Model model, @PathVariable Long e_id, OtherServiceInformation otherServiceInformation) {
        ...
        return "pims/selfservice/otherserviceinformation";
    }
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid OtherServiceInformation otherServiceInformation, BindingResult bindingResult) {
        ...
        return "redirect:/selfservice_otherserviceinformation/index/{e_id}";
    }
