 ...
 */
@Controller
@RequestMapping("/selfservice_magisterialpower")
@PreAuthorize("hasAuthority('selfservice_magisterialpower')")
public class MagisterialPowerSelfserviceController {
    ...
    public String edit(Model model, @PathVariable Long id, MagisterialPower magisterialPower) {
        model.addAttribute("magisterialPower", magisterialPowerRepository.getOne(id));
        Users users = new Users();
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid MagisterialPower magisterialPower, BindingResult bindingResult) {
        ...
        return "redirect:/selfservice_magisterialpower/index/{e_id}";
    }
