 ...
 */
@Controller
@RequestMapping("/selfservice_disciplinaryaction")
@PreAuthorize("hasAuthority('selfservice_disciplinaryaction')")
public class DisciplinaryActionSelfserviceController {
    ...
    public String index(Model model, @PathVariable Long e_id, DisciplinaryActionDetails disciplinaryActionDetails) {
        ...
        return "pims/selfservice/disciplinaryaction";
    }
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid DisciplinaryActionDetails disciplinaryActionDetails, BindingResult bindingResult) {
        ...
        return "redirect:/selfservice_disciplinaryaction/index/{e_id}";
    }
