 ...
 */
@Controller
@RequestMapping("/selfservice_publication")
@PreAuthorize("hasAuthority('selfservice_publication')")
public class PublicationInformationSelfserviceController {
    ...
    public String index(Model model, @PathVariable Long e_id, PublicationInformation publicationInformation) {
        ...
        return "pims/selfservice/publication";
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid PublicationInformation publicationInformation, BindingResult bindingResult) {
        ...
        return "redirect:/selfservice_publication/index/{e_id}";
    }
