 ...
 */
@Controller
@RequestMapping("/selfservice_postingabroadinformation")
@PreAuthorize("hasAuthority('selfservice_postingabroadinformation')")
public class PostingAbroadInformationSelfserviceController {
    ...
    public String index(Model model, @PathVariable Long e_id, PostingAbroadInformation postingAbroadInformation) {
        ...
        return "pims/selfservice/postingabroadinformation";
    }
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid PostingAbroadInformation postingAbroadInformation, BindingResult bindingResult) {
        ...
        return "redirect:/selfservice_postingabroadinformation/index/{e_id}";
    }
