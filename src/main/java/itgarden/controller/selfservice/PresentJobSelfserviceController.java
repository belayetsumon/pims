 ...
 */
@Controller
@RequestMapping("/selfservice_presentjob")
@PreAuthorize("hasAuthority('selfservice_presentjob')")
public class PresentJobSelfserviceController {
    ...
    public String Index(Model model, @PathVariable Long e_id, PresentJob presentJob) {
        ...
        return "pims/selfservice/presentjob";
    }
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid PresentJob presentJob, BindingResult bindingResult) {
        ...
        presentJob.setCreatedBy(loggedUserService.activeUserNameAndGovernmentId());
        presentJob.setUpdatedBy(loggedUserService.activeUserNameAndGovernmentId());
        presentJobRepository.save(presentJob);
        return "redirect:/selfservice_presentjob/index/{e_id}";
    }
