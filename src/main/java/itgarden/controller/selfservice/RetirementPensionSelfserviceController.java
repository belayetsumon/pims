 ...
 */
@Controller
@RequestMapping("/selfservice_retirementpension")
@PreAuthorize("hasAuthority('selfservice_retirementpension')")
public class RetirementPensionSelfserviceController {
    ...
    public String index(Model model, @PathVariable Long e_id, RetirementPension retirementPension) {
        ...
        return "pims/selfservice/retirementpension";
    }
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid RetirementPension retirementPension, BindingResult bindingResult) {
        ...
        return "redirect:/selfservice_retirementpension/index/{e_id}";
    }
