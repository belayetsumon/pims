 ...
 */
@Controller
@RequestMapping("/selfservice_spouse")
@PreAuthorize("hasAuthority('selfservice_spouse')")
public class SpousNameSelfserviceController {
    ...
    public String index(Model model, @PathVariable Long e_id, SpousName spousName) {
        ...
        return "pims/selfservice/spouse";
    }
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid SpousName spousName, BindingResult bindingResult) {
        ...
        return "redirect:/selfservice_spouse/index/{e_id}";
    }
