 ...
 */
@Controller
@RequestMapping("/selfservice_jobentryprocess")
@PreAuthorize("hasAuthority('selfservice_jobentryprocess')")
public class JobEntryProcessSelfserviceController {
    ...
    public String index(Model model, @PathVariable Long e_id, JobEntryProcess jobEntryProcess) {
        ...
        return "pims/selfservice/jobentryprocess";
    }
    ...
    public String save(Model model, @PathVariable Long e_id, @Valid JobEntryProcess jobEntryProcess, BindingResult bindingResult) {
        ...
        return "redirect:/selfservice_jobentryprocess/index/{e_id}";
    }
