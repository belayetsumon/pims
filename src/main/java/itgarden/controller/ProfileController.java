...
public class ProfileController {
    ...
    @RequestMapping(value = "/downloadpdf/{e_id}", produces = "application/pdf")
    @ResponseBody
    public void downloadpdf(Model model, @PathVariable Long e_id) throws FileNotFoundException, DocumentException {
