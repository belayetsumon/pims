...
@Entity
public class ForeignTrainingInformation {
...
//   @Version
    ...
    public ForeignTrainingInformation() {
    }

    public ForeignTrainingInformation(Long id, Users governmentId, String typeofTraining, String country, String trainingInstitute, String position, String periodFrom, String periodTo, long version, String createdBy, String updatedBy) {
        this.id = id;
