...
public class AdditionalQualification {
    ...
    @NotEmpty(message = "Qualification  field cannot be blank.")
    ...
    public AdditionalQualification(Long id, Users governmentId, String qualification, String createdBy, String updatedBy) {
        this.id = id;
